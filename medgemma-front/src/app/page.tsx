...
export default function Home() {
  // Estado para controlar se o painel foi iniciado
  const [isStarted, setIsStarted] = useState(false);
  
  // Estado para o relógio (evita erros de hidratação no Next.js)
  ...
  return (
    <main className="min-h-screen bg-[#1A3644] p-4 flex flex-col font-sans">
      ...
      <div className="relative flex-1 bg-[#F8F9FA] rounded-[20px] overflow-hidden flex shadow-2xl shadow-black/20">
        
        {/* Bolhas Flutuantes (Fundo) */}
        ...
        {!isStarted ? (
          <div className="relative z-10 pl-[10%] md:pl-[15%] flex flex-col justify-center h-full w-full animate-in fade-in duration-700">
            <h1 className="text-[#35596C] flex flex-col leading-[0.9] font-[family-name:var(--font-plus-jakarta)]">
            ...
            <button 
              ...
              className="mt-12 group flex items-center gap-4 bg-[#35596C] text-white px-8 py-4 rounded-full text-xl font-medium hover:bg-[#254150] transition-all w-max shadow-lg shadow-[#35596C]/20"
            >
              Iniciar Painel
          ...
          /* TELA 2: Painel do Assistente Clínico (Estrutura do HTML adaptada para Minimalista) */
